...
def do_work(s3, run_id, source_name, job_contents_b64, render_preview, output_dir, layer=None, layersource=None, mapbox_key=None):
    ...
    if layer is not None and layersource is not None:
        cmd +=('--layer', layer)
        cmd +=('--layersource', layersource)
